...
if __name__ == '__main__':
    ...
    url = 'https://www.manta.com/more-results/35_A72139EW_000?pg=30'
    ...
    while True:
        berause1 = redis_save.srandmember(REDIS['manta_comp'])
        if berause1:
